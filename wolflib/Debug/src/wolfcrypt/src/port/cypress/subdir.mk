...
C_SRCS += \
../src/wolfcrypt/src/port/cypress/psoc6_crypto.c 

LST += \
psoc6_crypto.lst 

C_DEPS += \
./src/wolfcrypt/src/port/cypress/psoc6_crypto.d 

OBJS += \
./src/wolfcrypt/src/port/cypress/psoc6_crypto.o 
...
src/wolfcrypt/src/port/cypress/%.o: ../src/wolfcrypt/src/port/cypress/%.c
	@echo 'Building file: $<'
